...
export const projects: Project[] = [
  ...
  {
    id: "hyperlocal-ad",
    title: "Hyperlocal Ad Optimizer",
    subtitle: "AI-powered growth engine helping SMEs design and optimize hyperlocal campaigns.",
    category: "Product Strategy",
    techStack: ["Python", "React", "OpenAI API", "Analytics"],
    imageUrl: "/projects/hyperlocal-dashboard.png",
    repoUrl: "https://github.com/CrillyPienaah/hyperlocal-ad-optimizer",
    featured: true,
    description: "Reduced campaign setup time by 90% via generative AI copy and targeting automation.",
    problem: "Small business owners (SMEs) lack the time and expertise to run effective digital ad campaigns. Agencies are too expensive, and self-serve tools are too complex, leading to wasted marketing budgets.",
    solution: "I developed a 'Growth Engine' that uses Generative AI to automatically write ad copy, select target demographics, and optimize bidding strategies based on simple user inputs. The system acts as an autonomous marketing manager.",
    impact: [
      "Reduced campaign setup time from 4 hours to 15 minutes (94% reduction).",
      "Integrated OpenAI API to generate high-conversion ad copy variants.",
      "Built a multi-tenant architecture allowing secure data separation for different clients."
    ]
   },
   {
    id: "customer-churn",
    ...
    imageUrl: "/projects/churn-feature-importance.png", // Use the feature importance chart
    featured: true,
...

  {
    ...
    imageUrl: "/projects/propensity-roc-curve.png", // Use the ROC curve
    featured: true,
